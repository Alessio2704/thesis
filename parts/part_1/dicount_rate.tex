...
\begin{align*}
    W_E & = \frac{MV_{\text{Equity}}}{\text{Total Market Value of Capital}}          \\[6pt]
    W_D & = \frac{MV_{\text{Debt}}}{\text{Total Market Value of Capital}}            \\[6pt]
...
\begin{enumerate}
    \item \textbf{Using Sovereign Credit Default Swap (CDS) Spreads} \label{sec:cds_spreads}:\\
          ...
          \begin{table}[H]
              \centering
              \caption{Illustrative Sovereign CDS Spreads (Basis Points)}
              \label{tab:cds_country_prices_example}
              \vspace{2mm}
              \begin{tabular}{|l|c|}
                  \hline
                  \textbf{Country} & \textbf{10Y CDS Spread (bps)} \\ \hline
                  Germany          & 24                            \\ \hline
                  USA              & 39                            \\ \hline
                  Japan            & 31                            \\ \hline
                  Italy            & 106                           \\ \hline
              ...
              \textit{Note:} Data reflects illustrative 10-year sovereign Credit Default Swap spreads as of March 2025. Spreads are highly dynamic and fluctuate based on macroeconomic conditions and perceived sovereign risk.\\
              \textit{Source:} Data retrieved from market aggregators.
          \end{table}

    \item \textbf{Using Sovereign Ratings}:\\
          ...
          \begin{table}[H]
              \centering
              \caption{Illustrative Default Spreads by Rating Category}
              \label{tab:rating_default_spreads_example}
              \vspace{2mm}
              \begin{tabular}{|l|c|}
                  \hline
                  \textbf{Rating} & \textbf{Illustrative Default Spread} \\ \hline
                  AAA             & 0.45\%                               \\ \hline
                  AA              & 0.60\%                               \\ \hline
                  A+              & 0.77\%                               \\ \hline
                  A               & 0.85\%                               \\ \hline
              ...
              \vspace{2mm}
              \raggedright \footnotesize
              \textit{Note:} Spreads fluctuate with market conditions. Data as of March 2025.\\
              \textit{Source:} \textcite{damodaran_data_2025}.
          \end{table}

    \item \textbf{Using Differentials on Foreign Currency Bonds}:\\
          ...
          \begin{align*}
              \text{Country Default Spread} & \approx \text{Yield on Govt's FX Bond} - \text{Yield on Benchmark FX Bond} \\[6pt]
              R_F                           & = Y_{Govt} - \text{Country Default Spread}
          \end{align*}
...
As shown by \textcite{hamada1972beta}, company specific leverage explains around 21\% to 24\% of observed systematic risk of common stocks (under the assumptions that Modigliani and Miller (MM) Theory holds).
...
Given the limitations of direct regression betas (Section \ref{par:regression_beta_limitations}), this thesis adopts a "bottom-up" approach to estimate the company's Levered Beta (\(\beta_L\)) following the work of \textcite{damodaran_risk_parameters}.
...
\paragraph{"Pure-Play Companies"} \label{par:pure_play_companies}
...
\begin{enumerate}
    ...
    \item \textbf{Calculate Weighted Average ERP}: The company-specific ERP is the sum of the ERP for each region weighted by the proportion of revenues from that region:
          \begin{align*}
              ERP_{\text{Company}} & = \sum_{\text{All Regions}} \left( W_{\text{Region}} \times ERP_{\text{Region}} \right)                       \\[6pt]
...
\begin{table}[H]
    ...
    \vspace{2mm}
    \raggedright \footnotesize
    \textit{Note:} Spreads are indicative and vary with market conditions and firm size. Required ratios may differ for smaller firms.\\
    \textit{Source:} \textcite{damodaran_data_2025}.
\end{table}
