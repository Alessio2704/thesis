...
The following chapters will focus on each of the core inputs to this equation (\(N,\space r, \space FCFF_n,\space TV\)) providing a framework for their estimation and utilization within the valuation model.

\input{parts/part_1/forecasting_period}

\input{parts/part_1/dicount_rate}

\input{parts/part_1/fcff}

\input{parts/part_1/terminal_value}

\input{parts/part_1/valuation_adjustments}
